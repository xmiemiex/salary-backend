...
type Data = { coverageScope: 'full_month' | 'month_to_date' | 'future'; localSample: boolean; month: string; locked: boolean; columns: { key: string; name: string }[]; rates: Record<string, string | null>; rows: Row[]; totals: Amounts; sources: { key: string; name: string; status: string; statusLabel?: string; unmatchedCount?: number; reason: string | null; lastSuccessAt: string | null; coveredThrough: string | null; updatedAt: string | null }[]; complete: boolean; refreshing: boolean; batchId: string | null; queriedAt: string; coveredThrough: string | null };
